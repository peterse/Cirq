...
def inst_all_gates():
    ...
    for func in get_single_qubit_gates():
        print(type(func(q[0])._gate))
    for func in get_parametrized_single_qubit_gates():
        print(type(func(3.3)(q[0])._gate))
    for func in get_two_qubit_gates():
        print(type(func(q[0], q[1])._gate))
    for func in get_parametrized_two_qubit_gates():
        print(type(func(q[0], q[1])._gate))
